...
const London = () => {
  ...
  return (
    <PageLayout>
      <SEO
        title="Construction Site Broadband London | Temporary Connectivity | Integra Networks"
        description="Fast broadband for London construction sites. City, Canary Wharf, Stratford, Croydon. Temporary deployment, site cabins, emergency connectivity. 48-hour installation."
