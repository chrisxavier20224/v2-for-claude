...
import { Cable, Server, Wifi, ClipboardCheck, Building2, Network, Wrench, Shield, Radio } from "lucide-react";
...
const services = [
  ...
  {
    icon: Wifi,
    title: "Wi-Fi Surveys & Heat Mapping",
...
const processSteps = [
  {
    step: "01",
    title: "Site Survey",
    description: "We walk your building. Every floor, every room, every outbuilding. We audit existing cabling and cabinets, measure Wi-Fi coverage with heat mapping tools, and document everything — floor plans, photos, signal data.",
  },
  {
    step: "02",
...
const schemaData = {
  ...
  description: "End-to-end network infrastructure services including structured cabling, data cabinets, PoE switching, Wi-Fi surveys, fibre links, and project management for commercial buildings across the UK.",
  ...
  return (
    <PageLayout>
      <SEO
        ...
        description="Cabling, cabinets, PoE switches, Wi-Fi surveys, and fibre links. Design, install, manage."
        keywords="network infrastructure, structured cabling, data cabinet, PoE switch, Wi-Fi survey, heat map, fibre link, network installation, cable management"
      ...
      <section className="relative min-h-[70vh] flex items-end overflow-hidden -mt-20">
        ...
        <div className="relative z-10 mx-auto max-w-6xl w-full px-4 sm:px-6 pb-16 pt-40">
          <AnimatedSection>
            ...
            >
              Cabling, cabinets, switches, fibre links, Wi-Fi surveys — planned, installed, and managed end-to-end. One team, one project, one point of contact.
            </motion.p>
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          <div className="grid gap-12 md:gap-16 md:grid-cols-2 items-center">
            <AnimatedSection className="order-2 md:order-1">
              <motion.div whileHover={{ scale: 1.02 }} transition={{ duration: 0.4 }} className="rounded-2xl overflow-hidden">
                <img src={surveyImg} alt="Wi-Fi survey and network design" className="w-full aspect-[4/3] object-cover" loading="lazy" />
              </motion.div>
            </AnimatedSection>
            <AnimatedSection className="order-1 md:order-2">
              <p className="text-xs font-semibold uppercase tracking-widest text-primary mb-3">Wi-Fi Surveys</p>
      ...
      <section className="relative bg-surface-dark py-20 md:py-28 overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6">
          ...
          >
            {[
              { icon: Building2, title: "Commercial Buildings", description: "Offices, conference centres, and shared workspaces that need structured cabling and managed Wi-Fi from the ground up." },
              ...
              { icon: Wrench, title: "Hospitality & Events", description: "Hotels, retreat centres, and event venues needing guest Wi-Fi across indoor and outdoor areas with phased rollout." },
