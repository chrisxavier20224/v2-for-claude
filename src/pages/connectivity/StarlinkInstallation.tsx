        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          <AnimatedSection>
            ...
            <p className="text-lg text-surface-dark-muted text-center max-w-3xl mx-auto mb-16">
              Starlink delivers up to 400Mbps almost anywhere — impressive for rural locations. But heavy rain degrades signal, latency spikes disrupt VoIP calls, and there's no SLA. Our solution: add 4G/5G cellular as automatic failover. When Starlink drops, you switch in 100ms.
            </p>
          </AnimatedSection>
        </div>
      </section>
          ...
          <div className="grid gap-12 lg:gap-16 grid-cols-1 lg:grid-cols-2 lg:items-center">
            ...
            <AnimatedSection className="order-1 lg:order-2">
              ...
              <p className="text-lg text-surface-dark-muted leading-relaxed mb-6">
                Your Starlink dish delivers up to 400Mbps. We add a 4G/5G modem on a second network. Our router talks to both and routes traffic to whichever is better. If Starlink drops, it switches to 4G/5G instantly. You get speed from Starlink, reliability from cellular, one connection to your devices.
              </p>
