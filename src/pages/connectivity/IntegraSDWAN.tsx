...
const pricingTiers = [
  { name: "Integra Connect", speed: "Speeds vary by location", price: "59", staticIp: "", install: "£1,250", features: ["Single-network 4G/5G", "Professional installation"], link: "/connectivity/integra-connect" },
