...
const painPoints = [
  {
    ...
    description: "SoGEA removes the traditional phone line entirely. No legacy copper voice circuit, no line rental — just broadband-only access over the same physical infrastructure.",
  },
  {
    icon: Clock,
...
const faqs = [
  ...
  { q: "What happens to my phone calls?", a: "SoGEA removes the traditional phone line. You'll need a VoIP solution for voice calls. We offer hosted VoIP with full number porting — your customers won't notice any change." },
  ...
  { q: "What if I need faster speeds?", a: "If SoGEA speeds (up to 80Mbps) aren't enough, consider Integra SD-WAN for up to 500Mbps via bonded cellular, or a leased line for symmetric gigabit speeds." },
];
      ...
      <Section size="large">
        <div className="grid gap-12 lg:gap-16 grid-cols-1 lg:grid-cols-2 lg:items-center">
          ...
          <AnimatedSection className="order-1 lg:order-2">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-6">
              Teams integration, call routing, voicemail-to-email, call recording, and full number porting. Your customers dial the same number they always have.
            </p>
            <motion.div whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.97 }}>
