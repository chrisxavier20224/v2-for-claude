...
const ProvisioningSilence = () => {
  ...
  return (
    <>
      <style>{`
        .ps-band { display:block; margin:2.5rem 0; }
        .ps-band svg { width:100%; height:auto; display:block; border-radius:12px; font-family: Inter, -apple-system, 'Segoe UI', Helvetica, Arial, sans-serif; }
