...
export const PRODUCTS = [
  {
    ...
    frequency: '/month',
    vat: true,
    description: 'Professional installation, UK-based support, enterprise-grade equipment',
    minPainPoints: 0,
  },
  {
    id: 'integra_pro',
    ...
    frequency: '/month',
    vat: true,
    description: 'Dedicated bandwidth, priority support, managed service',
    minPainPoints: 2,
  },
  {
    id: 'managed_sim',
    ...
    frequency: '/month',
    vat: true,
    description: 'Mobile backup connectivity, failover capability',
    minPainPoints: 0,
  },
  {
    id: 'enterprise',
    ...
    frequency: '/month',
    vat: true,
    description: 'Custom solutions, dedicated account management, SLA guarantees',
    minPainPoints: 3,
  },
  {
    id: 'leased_line',
